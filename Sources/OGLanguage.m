...
+ (NSDictionary<NSString *, NSDictionary<NSString *, NSString *> *> *)translations {
    return @{
        @"en": @{
            ...
            @"display_name": @"Display name", @"actions": @"Actions", @"new_rule": @"New rule", @"edit_rule": @"Edit rule", @"delete_rule": @"Delete rule", @"confirm": @"Confirm",
            @"move_group_up": @"Move group up", @"move_group_down": @"Move group down",
            @"delete_selection_title": @"Delete selected items?", @"delete_selection_confirm": @"Delete",
            @"delete_selection_message": @"This will delete %lu groups and %lu rules. Selected groups and all their rules will be removed, including collapsed rules. This cannot be undone. Your files will not be deleted.",
            @"delete_group_prompt": @"Delete group “%@”?", @"delete_group_only": @"Delete Group Only",
            @"delete_group_and_rules": @"Delete Group and Rules", @"delete_group_choices_message": @"Deleting only the group moves its rules to the root and preserves application bindings. Deleting both removes the group and all its rules.",
        ...
        @"zh-Hans": @{
            ...
            @"display_name": @"显示名称", @"actions": @"操作", @"new_rule": @"待填写规则", @"edit_rule": @"编辑规则", @"delete_rule": @"删除规则", @"confirm": @"确认",
            @"move_group_up": @"上移分组", @"move_group_down": @"下移分组",
            @"delete_selection_title": @"删除选中的项目？", @"delete_selection_confirm": @"删除",
            @"delete_selection_message": @"将删除 %lu 个分组和 %lu 条规则。选中的分组及组内全部规则会一起移除，包括折叠隐藏的规则。此操作不可撤销，不会删除您的文件。",
            @"delete_group_prompt": @"删除分组“%@”？", @"delete_group_only": @"仅删除分组",
            @"delete_group_and_rules": @"删除分组和规则", @"delete_group_choices_message": @"仅删除分组：组内规则移到根目录，并保留应用绑定。删除分组和规则：移除该分组及其全部规则。",
        ...
        @"ja": @{
            ...
            @"display_name": @"表示名", @"actions": @"操作", @"new_rule": @"未入力のルール", @"edit_rule": @"ルールを編集", @"delete_rule": @"ルールを削除", @"confirm": @"確定",
            @"move_group_up": @"グループを上へ", @"move_group_down": @"グループを下へ",
            @"delete_selection_title": @"選択した項目を削除しますか？", @"delete_selection_confirm": @"削除",
            @"delete_selection_message": @"%lu 個のグループと %lu 件のルールを削除します。選択したグループ内のルールは折りたたまれたものもすべて削除されます。この操作は取り消せません。ファイルは削除されません。",
            @"delete_group_prompt": @"グループ「%@」を削除しますか？", @"delete_group_only": @"グループのみ削除",
            @"delete_group_and_rules": @"グループとルールを削除", @"delete_group_choices_message": @"グループのみ削除するとルールとアプリの割り当てはルートに保持されます。両方を削除するとグループ内のルールもすべて削除されます。",
        ...
        @"ko": @{
            ...
            @"display_name": @"표시 이름", @"actions": @"작업", @"new_rule": @"새 규칙", @"edit_rule": @"규칙 편집", @"delete_rule": @"규칙 삭제", @"confirm": @"확인",
            @"move_group_up": @"그룹 위로 이동", @"move_group_down": @"그룹 아래로 이동",
            @"delete_selection_title": @"선택한 항목을 삭제할까요?", @"delete_selection_confirm": @"삭제",
            @"delete_selection_message": @"그룹 %lu개와 규칙 %lu개를 삭제합니다. 선택한 그룹 안의 규칙은 접힌 규칙까지 모두 삭제됩니다. 되돌릴 수 없습니다. 파일은 삭제되지 않습니다.",
            @"delete_group_prompt": @"“%@” 그룹을 삭제할까요?", @"delete_group_only": @"그룹만 삭제",
            @"delete_group_and_rules": @"그룹과 규칙 삭제", @"delete_group_choices_message": @"그룹만 삭제하면 규칙과 앱 연결은 루트에 유지됩니다. 모두 삭제하면 그룹 안의 모든 규칙도 제거됩니다.",
        ...
        @"es": @{
            ...
            @"display_name": @"Nombre visible", @"actions": @"Acciones", @"new_rule": @"Regla pendiente", @"edit_rule": @"Editar regla", @"delete_rule": @"Eliminar regla", @"confirm": @"Confirmar",
            @"move_group_up": @"Subir grupo", @"move_group_down": @"Bajar grupo",
            @"delete_selection_title": @"¿Eliminar los elementos seleccionados?", @"delete_selection_confirm": @"Eliminar",
            @"delete_selection_message": @"Se eliminarán %lu grupos y %lu reglas. Se eliminarán todas las reglas de los grupos seleccionados, incluso las ocultas al contraerlos. No se puede deshacer. Tus archivos no se eliminarán.",
            @"delete_group_prompt": @"¿Eliminar el grupo «%@»?", @"delete_group_only": @"Eliminar solo el grupo",
            @"delete_group_and_rules": @"Eliminar grupo y reglas", @"delete_group_choices_message": @"Eliminar solo el grupo mueve sus reglas a la raíz y conserva sus aplicaciones. Eliminar ambos borra el grupo y todas sus reglas.",
